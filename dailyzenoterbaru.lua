...
webhookURL =
    'https://discord.com/api/webhooks/1430686523157647511/LXlheS6k9mV34_S3-4jFyp8uRoqwsg6ZeVnyjODFLDNwBmYSKXYxN5RQHcaIsylCQ0yz'
...
game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182"):WaitForChild("\229\133\172\231\148\168"):WaitForChild("\230\138\128\232\131\189"):WaitForChild("\228\189\191\231\148\168\230\138\128\232\131\189"):FireServer(unpack(args))
end
...
function SwitchToPreset1()
local args = {
	1
}
game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182"):WaitForChild("\229\133\172\231\148\168"):WaitForChild("\230\138\128\232\131\189"):WaitForChild("\229\136\135\230\141\162\232\163\133\229\164\135\231\187\132"):FireServer(unpack(args))

end

function SwitchToPreset2()
local args = {
	2
}
game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182"):WaitForChild("\229\133\172\231\148\168"):WaitForChild("\230\138\128\232\131\189"):WaitForChild("\229\136\135\230\141\162\232\163\133\229\164\135\231\187\132"):FireServer(unpack(args))
...
task.spawn(function()
    ...
    local features = window:AddTab('Rd')
    ...
    local features7 = window:AddTab('Config')
    local features8 = window:AddTab('Farms')
    ...
    game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182"):WaitForChild("\229\133\172\231\148\168"):WaitForChild("\233\130\174\228\187\182"):WaitForChild("\233\162\134\229\143\150\229\133\168\233\131\168\233\130\174\228\187\182"):FireServer()
    ...
    local function setupFeatures2Tab(features2)
        ...
        local EndlessBattle = features2:AddSwitch('Endless Wave for Stage 50', function(bool)
	...
	features5:AddButton('Auto Skill Rotation', function(btn)
    AutoSkill = not AutoSkill

end)

features5:AddButton('Save Position (Waypoint)', function()
    SavedCFrame = getHRP().CFrame
end)

features5:AddButton('Auto Teleport', function(btn)
    AutoTP = not AutoTP
